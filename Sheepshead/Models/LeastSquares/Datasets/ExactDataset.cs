// -----------------------------------------------------------------------
// <copyright file="ExactDataset.cs" company="ComponentOwl.com">
...
namespace Sheepshead.Models.LeastSquares
{
    ...
    /// <summary>
    ///   Generates set of points laying on the model function.
    /// </summary>
    internal sealed class ExactDataset : Dataset
    {
        /// <summary>
