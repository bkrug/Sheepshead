...
namespace Sheepshead.Models.Players.Stats
{
    public class NeuralNetwork
    {
        ...
        // Back-propagastion momentum-specific arrays.
        ...
        {
            // Initialize wieghts and biases to small random values.
            int numWeights = (numInput * numHidden) + (numHidden * numOutput) + numHidden + numOutput;
        ...
        private double[] ComputeOutputs(double[] xValues)
        {
            ...
            for (int j = 0; j < numHidden; ++j) // Computer i-h sum of weights * inputs.
                for (int i = 0; i < numInput; ++i)
        ...
        {
            // Update the weights and biases using ack-propagation.
            ...
            for (int i = 0; i < numInput; ++i) // 0..2 (3)
            {
                ...
                {
                    double delta = learnRate * hGrads[j] * inputs[i]; // Computer the new delta.
        ...
        public void Train(double[][] trainData, int maxEpochs, double learnRate, double momentum)
        {
            ...
            while (epoch < maxEpochs)
            {
                ...
                for (int i = 0; i < trainData.Length; ++i)
                {
                    ...
                    ComputeOutputs(xValues); // Copy xValues in, compute outputs (store these internally).
        ...
        {
            // Average squared error per taining item.
        ...
        public double Accuracy(double[][] testData)
        {
            ...
            for (int i = 0; i < testData.Length; ++i)
            {
                ...
                int maxIndex = MaxIndex(yValues); // Which cell in yValues has the largest values?
