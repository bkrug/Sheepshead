...
namespace Sheepshead.Tests
{
    ...
    public class GameRepositoryTests
    {
        ...
        public void GameRepository_CreationOfGameRetainsGame()
        {
            ...
            var game = repository.Create(1, 4, 0, PartnerMethod.JackOfDiamonds);
        ...
        public void GameRepository_GetGameReturnsCorrectGame()
        {
            var dict = new Dictionary<Guid, IGame>();
            var repository = new GameRepository(dict);
            var expected0 = AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
            var expected1 = AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
            var expected2 = AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
        ...
        public void GameRepository_GetGameReturnsCorrectGame2()
        {
            ...
            var expected = 
            AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
            AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
            AddGame(dict, new Game(new List<IPlayer>(), PartnerMethod.JackOfDiamonds, new RandomWrapper(), null, null));
