...
using Sheepshead.Models.Neural;
    ...
    public class NeuralTests
    {
        ...
        public void TestFromBook()
        {
            using (var Console = new StreamWriter(@"c:\temp\neural-test.txt"))
            {
                 ...
                 ShowMatrix(allData, 6, 1, true, Console);
                 ...
                 ShowMatrix(trainData, 3, 1, true, Console);
                 Console.WriteLine("First 3 rows of test data:");
                 ShowMatrix(testData, 3, 1, true, Console);
                 ...
                 ShowVector(weights, 10, 3, true, Console);
        ...
        static void ShowVector(double[] vector, int valsPerRow, int decimals, bool newLine, StreamWriter Console)
        {
        ...
        static void ShowMatrix(double[][] matrix, int numRows, int decimals, bool newLine, StreamWriter Console)
        {
