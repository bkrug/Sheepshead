...
namespace Sheepshead.React.Controllers
{
    ...
    {
        [HttpPost]
        public IActionResult Create(int humanCount, int simpleCount, int intermediateCount, string partnerCard, string leastersGame)
        {
            ...
            var game = repository.Create(humanCount, simpleCount, intermediateCount, partnerMethod, leastersOn);
