...
namespace Sheepshead.Tests
{
    ...
    public class AdvancedPlayerTests
    {
        ...
        public void AdvancedPlayer_FivePlayerGame_ManyPowerfulTrump_ShouldPick()
        {
            ...
            advancedPlayer.AddCard(SheepCard.JACK_SPADES);
            advancedPlayer.AddCard(SheepCard.QUEEN_CLUBS);
            advancedPlayer.AddCard(SheepCard.QUEEN_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.QUEEN_HEARTS);
            advancedPlayer.AddCard(SheepCard.QUEEN_SPADES);
            advancedPlayer.AddCard(SheepCard.N9_DIAMONDS);
        ...
        public void AdvancedPlayer_FivePlayerGame_ManyWeakTrumpFewPointsTowardsFront_ShouldPass()
        {
            ...
            var advancedPlayer = players.OfType<AdvancedPlayer>().Single();
            advancedPlayer.AddCard(SheepCard.QUEEN_CLUBS);
            advancedPlayer.AddCard(SheepCard.N9_SPADES);
            advancedPlayer.AddCard(SheepCard.KING_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N7_HEARTS);
            advancedPlayer.AddCard(SheepCard.N8_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N9_DIAMONDS);
            var handMock = new Mock<IHand>();
            handMock.Setup(m => m.Players).Returns(players);
            handMock.Setup(m => m.PlayerCount).Returns(players.Count);
        ...
        public void AdvancedPlayer_FivePlayerGame_FewTrump_ShouldPass()
        {
            ...
            var advancedPlayer = players.OfType<AdvancedPlayer>().Single();
            advancedPlayer.AddCard(SheepCard.ACE_HEARTS);
            advancedPlayer.AddCard(SheepCard.N9_SPADES);
            advancedPlayer.AddCard(SheepCard.ACE_SPADES);
            advancedPlayer.AddCard(SheepCard.N7_HEARTS);
            advancedPlayer.AddCard(SheepCard.KING_CLUBS);
            advancedPlayer.AddCard(SheepCard.KING_SPADES);
            var handMock = new Mock<IHand>();
            handMock.Setup(m => m.Players).Returns(players);
            handMock.Setup(m => m.PlayerCount).Returns(players.Count);
            handMock.Setup(m => m.StartingPlayer).Returns(players[0]);
        ...
        public void AdvancedPlayer_ThreePlayerGame_ManyPowerfulTrump_ShouldPick()
        {
            ...
            advancedPlayer.AddCard(SheepCard.JACK_SPADES);
            advancedPlayer.AddCard(SheepCard.QUEEN_CLUBS);
            advancedPlayer.AddCard(SheepCard.ACE_CLUBS);
            advancedPlayer.AddCard(SheepCard.QUEEN_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N10_HEARTS);
            advancedPlayer.AddCard(SheepCard.QUEEN_HEARTS);
            advancedPlayer.AddCard(SheepCard.ACE_SPADES);
            advancedPlayer.AddCard(SheepCard.QUEEN_SPADES);
            advancedPlayer.AddCard(SheepCard.N9_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N10_CLUBS);
            var handMock = new Mock<IHand>();
            handMock.Setup(m => m.Players).Returns(players);
            handMock.Setup(m => m.PlayerCount).Returns(players.Count);
            handMock.Setup(m => m.StartingPlayer).Returns(players[0]);
        ...
        public void AdvancedPlayer_ThreePlayerGame_ManyWeakTrumpFewPointsTowardsFront_ShouldPass()
        {
            ...
            advancedPlayer.AddCard(SheepCard.N9_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N10_CLUBS);
            advancedPlayer.AddCard(SheepCard.N7_CLUBS);
            advancedPlayer.AddCard(SheepCard.KING_HEARTS);
            advancedPlayer.AddCard(SheepCard.N8_CLUBS);
            var handMock = new Mock<IHand>();
            handMock.Setup(m => m.Players).Returns(players);
            handMock.Setup(m => m.PlayerCount).Returns(players.Count);
            handMock.Setup(m => m.StartingPlayer).Returns(players[0]);
        ...
        public void AdvancedPlayer_ThreePlayerGame_ManyWeakTrumpFewPointsTowardsBack_ShouldPick()
        {
            ...
            advancedPlayer.AddCard(SheepCard.N9_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.N10_CLUBS);
            advancedPlayer.AddCard(SheepCard.N7_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.KING_HEARTS);
            advancedPlayer.AddCard(SheepCard.ACE_DIAMONDS);
            var handMock = new Mock<IHand>();
            handMock.Setup(m => m.Players).Returns(players);
            handMock.Setup(m => m.PlayerCount).Returns(players.Count);
            handMock.Setup(m => m.StartingPlayer).Returns(players[0]);
        ...
        public void AdvancedPlayer_ThreePlayerGame_FewTrump_ShouldPass()
        {
            ...
            advancedPlayer.AddCard(SheepCard.N7_HEARTS);
            advancedPlayer.AddCard(SheepCard.KING_CLUBS);
            advancedPlayer.AddCard(SheepCard.N8_HEARTS);
            advancedPlayer.AddCard(SheepCard.N10_CLUBS);
            advancedPlayer.AddCard(SheepCard.N7_CLUBS);
            advancedPlayer.AddCard(SheepCard.N9_SPADES);
            advancedPlayer.AddCard(SheepCard.N8_CLUBS);
        ...
        public void AdvancedPlayer_LeadTrick_OffensivePlayer_StrongCards_LeadWithStrongTrump1()
        {
            ...
            trickMock.Setup(t => t.CardsByPlayer).Returns(new Dictionary<IPlayer, SheepCard>());
        ...
        public void AdvancedPlayer_LeadTrick_DefensivePlayer_LeadWithSuitOfCalledAce()
        {
            ...
            var advancedPlayer = players.OfType<AdvancedPlayer>().Single();
            advancedPlayer.AddCard(SheepCard.N10_CLUBS);
            advancedPlayer.AddCard(SheepCard.N7_SPADES);
            advancedPlayer.AddCard(SheepCard.ACE_CLUBS);
            advancedPlayer.AddCard(SheepCard.KING_DIAMONDS);
            advancedPlayer.AddCard(SheepCard.KING_HEARTS);
            advancedPlayer.AddCard(SheepCard.JACK_HEARTS);
            var trickMock = new Mock<ITrick>();
            trickMock.Setup(t => t.CardsByPlayer).Returns(new Dictionary<IPlayer, SheepCard>());
            trickMock.Setup(t => t.StartingPlayer).Returns(advancedPlayer);
            trickMock.Setup(t => t.IHand.Leasters).Returns(false);
            trickMock.Setup(t => t.IHand.IGame.PartnerMethodEnum).Returns(PartnerMethod.CalledAce);
            trickMock.Setup(t => t.IHand.PartnerCardEnum).Returns(SheepCard.ACE_SPADES);
            var actual = advancedPlayer.GetMove(trickMock.Object);
        ...
        public void AdvancedPlayer_LeadTrick_DefensivePlayer_LeadWithNonTrumpThatYouHaveFewOf()
        {
            ...
            trickMock.Setup(t => t.IHand.PartnerCardEnum).Returns(SheepCard.JACK_DIAMONDS);
            var actual = advancedPlayer.GetMove(trickMock.Object);
